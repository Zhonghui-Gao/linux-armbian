...
#define TSK_ACTIVE_MM 1024 /* offsetof(struct task_struct, active_mm) */
...
#define MM_CONTEXT_ID 968 /* offsetof(struct mm_struct, context.id.counter) */

#define VMA_VM_MM 16 /* offsetof(struct vm_area_struct, vm_mm) */
#define VMA_VM_FLAGS 32 /* offsetof(struct vm_area_struct, vm_flags) */
...
#define VCPU_FAULT_DISR 2424 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 2368 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
#define CPU_USER_PT_REGS 0 /* offsetof(struct kvm_cpu_context, regs) */
#define CPU_RGSR_EL1 1760 /* offsetof(struct kvm_cpu_context, sys_regs[RGSR_EL1]) */
#define CPU_GCR_EL1 1768 /* offsetof(struct kvm_cpu_context, sys_regs[GCR_EL1]) */
#define CPU_APIAKEYLO_EL1 1616 /* offsetof(struct kvm_cpu_context, sys_regs[APIAKEYLO_EL1]) */
#define CPU_APIBKEYLO_EL1 1632 /* offsetof(struct kvm_cpu_context, sys_regs[APIBKEYLO_EL1]) */
#define CPU_APDAKEYLO_EL1 1648 /* offsetof(struct kvm_cpu_context, sys_regs[APDAKEYLO_EL1]) */
#define CPU_APDBKEYLO_EL1 1664 /* offsetof(struct kvm_cpu_context, sys_regs[APDBKEYLO_EL1]) */
#define CPU_APGAKEYLO_EL1 1680 /* offsetof(struct kvm_cpu_context, sys_regs[APGAKEYLO_EL1]) */
#define HOST_CONTEXT_VCPU 2088 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
