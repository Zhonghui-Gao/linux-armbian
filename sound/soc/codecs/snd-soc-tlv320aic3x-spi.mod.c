...
MODULE_INFO(depends, "snd-soc-tlv320aic3x,regmap-spi");

MODULE_ALIAS("spi:tlv320aic3x");
MODULE_ALIAS("spi:tlv320aic33");
MODULE_ALIAS("spi:tlv320aic3007");
MODULE_ALIAS("spi:tlv320aic3104");
MODULE_ALIAS("spi:tlv320aic3106");
