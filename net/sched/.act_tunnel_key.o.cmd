...
deps_net/sched/act_tunnel_key.o := \
  ...
  include/net/tc_wrapper.h \
    ...
    $(wildcard include/config/NET_ACT_PEDIT) \
    $(wildcard include/config/NET_ACT_SKBEDIT) \
    $(wildcard include/config/NET_ACT_SKBMOD) \
    $(wildcard include/config/NET_ACT_POLICE) \
    $(wildcard include/config/NET_ACT_BPF) \
    $(wildcard include/config/NET_ACT_CONNMARK) \
    $(wildcard include/config/NET_ACT_CSUM) \
    $(wildcard include/config/NET_ACT_CT) \
    $(wildcard include/config/NET_ACT_CTINFO) \
    $(wildcard include/config/NET_ACT_GATE) \
    $(wildcard include/config/NET_ACT_MPLS) \
    $(wildcard include/config/NET_ACT_NAT) \
    $(wildcard include/config/NET_ACT_TUNNEL_KEY) \
    $(wildcard include/config/NET_ACT_VLAN) \
    $(wildcard include/config/NET_ACT_IFE) \
    $(wildcard include/config/NET_ACT_IPT) \
    $(wildcard include/config/NET_ACT_SIMP) \
    $(wildcard include/config/NET_ACT_SAMPLE) \
    $(wildcard include/config/NET_CLS_BPF) \
    $(wildcard include/config/NET_CLS_U32) \
    $(wildcard include/config/NET_CLS_FLOWER) \
    $(wildcard include/config/NET_CLS_FW) \
    $(wildcard include/config/NET_CLS_MATCHALL) \
    $(wildcard include/config/NET_CLS_BASIC) \
    $(wildcard include/config/NET_CLS_CGROUP) \
    $(wildcard include/config/NET_CLS_FLOW) \
    $(wildcard include/config/NET_CLS_ROUTE4) \
