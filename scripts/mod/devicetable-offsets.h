...
#define SIZE_cdx_device_id 8 /* sizeof(struct cdx_device_id) */
#define OFF_cdx_device_id_vendor 0 /* offsetof(struct cdx_device_id, vendor) */
#define OFF_cdx_device_id_device 2 /* offsetof(struct cdx_device_id, device) */
