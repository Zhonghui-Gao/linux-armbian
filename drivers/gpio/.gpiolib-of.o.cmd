...
deps_drivers/gpio/gpiolib-of.o := \
    ...
    $(wildcard include/config/LCD_HX8357) \
    $(wildcard include/config/FEC) \
    $(wildcard include/config/PCI_IMX6) \
    $(wildcard include/config/REGULATOR_FIXED_VOLTAGE) \
    $(wildcard include/config/REGULATOR_GPIO) \
    $(wildcard include/config/REGULATOR) \
    $(wildcard include/config/STMMAC_ETH) \
    $(wildcard include/config/MFD_ARIZONA) \
    $(wildcard include/config/RTC_DRV_MOXART) \
    $(wildcard include/config/NFC_MRVL_I2C) \
    $(wildcard include/config/NFC_MRVL_SPI) \
    $(wildcard include/config/NFC_MRVL_UART) \
    $(wildcard include/config/PCI_LANTIQ) \
    $(wildcard include/config/REGULATOR_ARIZONA_LDO1) \
    $(wildcard include/config/REGULATOR_WM8994) \
    $(wildcard include/config/SND_SOC_CS42L56) \
    $(wildcard include/config/SND_SOC_TLV320AIC3X) \
    $(wildcard include/config/SPI_GPIO) \
    $(wildcard include/config/SPI_FSL_SPI) \
    $(wildcard include/config/SPI_PPC4xx) \
    $(wildcard include/config/TYPEC_FUSB302) \
    $(wildcard include/config/SND_SOC_MT2701_CS42448) \
    $(wildcard include/config/OF_DYNAMIC) \
    $(wildcard include/config/OF_GPIO_MM_GPIOCHIP) \
