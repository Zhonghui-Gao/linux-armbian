...
MODULE_ALIAS("of:N*T*Crockchip,rk3308-tsadc");
MODULE_ALIAS("of:N*T*Crockchip,rk3308-tsadcC*");
...
MODULE_ALIAS("of:N*T*Crockchip,rk3588-tsadc");
MODULE_ALIAS("of:N*T*Crockchip,rk3588-tsadcC*");
