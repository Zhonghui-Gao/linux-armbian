...
MODULE_INFO(depends, "qcom_common,qcom_q6v5,mdt_loader,qcom_sysmon,qcom_pil_info");

MODULE_ALIAS("of:N*T*Cqcom,msm8226-adsp-pil");
MODULE_ALIAS("of:N*T*Cqcom,msm8226-adsp-pilC*");
MODULE_ALIAS("of:N*T*Cqcom,msm8953-adsp-pil");
MODULE_ALIAS("of:N*T*Cqcom,msm8953-adsp-pilC*");
...
MODULE_ALIAS("of:N*T*Cqcom,sm6115-adsp-pas");
MODULE_ALIAS("of:N*T*Cqcom,sm6115-adsp-pasC*");
MODULE_ALIAS("of:N*T*Cqcom,sm6115-cdsp-pas");
MODULE_ALIAS("of:N*T*Cqcom,sm6115-cdsp-pasC*");
MODULE_ALIAS("of:N*T*Cqcom,sm6115-mpss-pas");
MODULE_ALIAS("of:N*T*Cqcom,sm6115-mpss-pasC*");
...
MODULE_ALIAS("of:N*T*Cqcom,sm8550-adsp-pas");
MODULE_ALIAS("of:N*T*Cqcom,sm8550-adsp-pasC*");
MODULE_ALIAS("of:N*T*Cqcom,sm8550-cdsp-pas");
MODULE_ALIAS("of:N*T*Cqcom,sm8550-cdsp-pasC*");
MODULE_ALIAS("of:N*T*Cqcom,sm8550-mpss-pas");
MODULE_ALIAS("of:N*T*Cqcom,sm8550-mpss-pasC*");
