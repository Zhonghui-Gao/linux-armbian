...
MODULE_ALIAS("usb:v05C6p9091d*dc*dsc*dp*ic*isc*ip*in02*");
MODULE_ALIAS("usb:v05C6p90B2d*dc*dsc*dp*ic*isc*ip*in03*");
MODULE_ALIAS("usb:v05C6p90DBd*dc*dsc*dp*ic*isc*ip*in02*");
...
MODULE_ALIAS("usb:v1199pC081d*dc*dsc*dp*ic*isc*ip*in08*");
...
MODULE_ALIAS("usb:v1BC7p1250d*dc*dsc*dp*ic*isc*ip*in00*");
...
MODULE_ALIAS("usb:v1E2Dp00B9d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1E2Dp00F3d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1E2Dp00F4d*dc*dsc*dp*ic*isc*ip*in00*");
...
MODULE_ALIAS("usb:v1546p1342d*dc*dsc*dp*ic*isc*ip*in04*");
