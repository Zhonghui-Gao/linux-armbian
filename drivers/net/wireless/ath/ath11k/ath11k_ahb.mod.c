...
MODULE_ALIAS("of:N*T*Cqcom,wcn6750-wifi");
MODULE_ALIAS("of:N*T*Cqcom,wcn6750-wifiC*");
MODULE_ALIAS("of:N*T*Cqcom,ipq5018-wifi");
MODULE_ALIAS("of:N*T*Cqcom,ipq5018-wifiC*");
