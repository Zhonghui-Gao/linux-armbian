...
MODULE_ALIAS("i2c:lsm6dsv");
MODULE_ALIAS("i2c:lsm6dsv16x");
MODULE_ALIAS("i2c:lsm6dso16is");
MODULE_ALIAS("i2c:ism330is");
MODULE_ALIAS("i2c:asm330lhb");
MODULE_ALIAS("acpi*:SMO8B30:*");
