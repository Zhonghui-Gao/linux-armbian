...
MODULE_ALIAS("spi:asm330lhhx");
MODULE_ALIAS("spi:lsm6dstx");
MODULE_ALIAS("spi:lsm6dsv");
MODULE_ALIAS("spi:lsm6dsv16x");
MODULE_ALIAS("spi:lsm6dso16is");
MODULE_ALIAS("spi:ism330is");
MODULE_ALIAS("spi:asm330lhb");
...
MODULE_ALIAS("of:N*T*Cst,lsm6dsv");
MODULE_ALIAS("of:N*T*Cst,lsm6dsvC*");
MODULE_ALIAS("of:N*T*Cst,lsm6dsv16x");
MODULE_ALIAS("of:N*T*Cst,lsm6dsv16xC*");
MODULE_ALIAS("of:N*T*Cst,lsm6dso16is");
MODULE_ALIAS("of:N*T*Cst,lsm6dso16isC*");
MODULE_ALIAS("of:N*T*Cst,ism330is");
MODULE_ALIAS("of:N*T*Cst,ism330isC*");
MODULE_ALIAS("of:N*T*Cst,asm330lhb");
MODULE_ALIAS("of:N*T*Cst,asm330lhbC*");
