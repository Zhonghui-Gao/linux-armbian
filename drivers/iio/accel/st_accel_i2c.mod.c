...
MODULE_INFO(depends, "st_sensors,st_accel,st_sensors_i2c");
...
MODULE_ALIAS("i2c:lsm303c_accel");
MODULE_ALIAS("i2c:sc7a20");
MODULE_ALIAS("i2c:iis328dq");
...
MODULE_ALIAS("of:N*T*Cst,lsm303c-accel");
MODULE_ALIAS("of:N*T*Cst,lsm303c-accelC*");
MODULE_ALIAS("of:N*T*Csilan,sc7a20");
MODULE_ALIAS("of:N*T*Csilan,sc7a20C*");
MODULE_ALIAS("of:N*T*Cst,iis328dq");
MODULE_ALIAS("of:N*T*Cst,iis328dqC*");
