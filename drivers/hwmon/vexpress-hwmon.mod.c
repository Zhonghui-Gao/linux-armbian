...
MODULE_ALIAS("of:N*T*Carm,vexpress-ampC*");
MODULE_ALIAS("of:N*T*Carm,vexpress-temp");
MODULE_ALIAS("of:N*T*Carm,vexpress-tempC*");
MODULE_ALIAS("of:N*T*Carm,vexpress-power");
MODULE_ALIAS("of:N*T*Carm,vexpress-powerC*");
MODULE_ALIAS("of:N*T*Carm,vexpress-energy");
MODULE_ALIAS("of:N*T*Carm,vexpress-energyC*");
