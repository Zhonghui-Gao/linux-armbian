...
MODULE_INFO(depends, "videobuf2-v4l2,dvb-core,videodev,rc-core,mc,tveeprom,videobuf2-common,videobuf2-vmalloc");
...
MODULE_INFO(srcversion, "0CDA872C0A44A301B8003B6");
