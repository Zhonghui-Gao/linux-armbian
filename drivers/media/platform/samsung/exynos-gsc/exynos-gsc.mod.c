...
MODULE_ALIAS("of:N*T*Csamsung,exynos5250-gsc");
MODULE_ALIAS("of:N*T*Csamsung,exynos5250-gscC*");
MODULE_ALIAS("of:N*T*Csamsung,exynos5420-gsc");
MODULE_ALIAS("of:N*T*Csamsung,exynos5420-gscC*");
