savedcmd_arch/arm64/kvm/hyp/nvhe/hyp.lds := aarch64-linux-gnu-gcc -E -Wp,-MMD,arch/arm64/kvm/hyp/nvhe/.hyp.lds.d -nostdinc -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -DKASAN_SHADOW_SCALE_SHIFT= -fmacro-prefix-map=./=   -P -Uarm64 -D__ASSEMBLY__ -DLINKER_SCRIPT -o arch/arm64/kvm/hyp/nvhe/hyp.lds arch/arm64/kvm/hyp/nvhe/hyp.lds.S
