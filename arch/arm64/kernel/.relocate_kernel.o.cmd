savedcmd_arch/arm64/kernel/relocate_kernel.o := aarch64-linux-gnu-gcc -Wp,-MMD,arch/arm64/kernel/.relocate_kernel.o.d -nostdinc -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -DKASAN_SHADOW_SCALE_SHIFT= -fmacro-prefix-map=./= -D__ASSEMBLY__ -fno-PIE -mabi=lp64 -fno-asynchronous-unwind-tables -fno-unwind-tables -DKASAN_SHADOW_SCALE_SHIFT= -g    -c -o arch/arm64/kernel/relocate_kernel.o arch/arm64/kernel/relocate_kernel.S 

source_arch/arm64/kernel/relocate_kernel.o := arch/arm64/kernel/relocate_kernel.S

deps_arch/arm64/kernel/relocate_kernel.o := \
...
arch/arm64/kernel/relocate_kernel.o: $(deps_arch/arm64/kernel/relocate_kernel.o)
